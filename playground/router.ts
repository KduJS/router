...
import Nested from './views/Nested.kdu'
import NestedWithId from './views/NestedWithId.kdu'
import Dynamic from './views/Dynamic.kdu'
import User from './views/User.kdu'
import NotFound from './views/NotFound.kdu'
const component = () => {
  console.log('fetching component')
  return import('./views/Generic.kdu')
}
import LongView from './views/LongView.kdu'
import GuardedWithLeave from './views/GuardedWithLeave.kdu'
import ComponentWithData from './views/ComponentWithData.kdu'
import { globalState } from './store'
import { scrollWaiter } from './scrollWaiter'
import RepeatedParams from './views/RepeatedParams.kdu'
import { FunctionalComponent, h } from 'kdu'
