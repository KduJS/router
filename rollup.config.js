...
const banner = `/*!
  ...
  * (c) 2021-${new Date().getFullYear()} NKDuy
  * @license MIT
  */`
...
// in kdu-router there are not that many
...
function createConfig(format, output, plugins = []) {
  ...
  output.globals = {
    ...
    // '@kdujs/devtools-api': 'KduDevtoolsApi',
  }
  ...
  if (isGlobalBuild) output.name = 'KduRouter'
  ...
  const external = ['kdu']
  if (!isGlobalBuild) {
    external.push('@kdujs/devtools-api')
  }
